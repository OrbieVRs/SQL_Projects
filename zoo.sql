...
SELECT a8.specialist_fname, a8.specialist_lname, a8.specialist_contact 
FROM tbl_species a1
INNER JOIN tbl_specialist a8 ON a8.specialist_id = a7.care_specialist
INNER JOIN tbl_species a1 ON a1.species_care = a7.care_id
